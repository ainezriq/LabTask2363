...
<?php
//This section processes submissions form the login form
//check if the form has been sum=bmitted
...
//Retrieve the id, first name, lastname, for the username and the password combination
...
<input id = "Password" type = "password" name = "Password" size="14" maxlength="60"
